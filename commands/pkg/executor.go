...
// This is a fallback for non-interactive modes (e.g., API).
// For richer content, use TUI `/init` or CLI `aura init` which use LLM exploration.
func (c *CommandProvider) generateBasicAuraMd(cwd string) string {
	var content strings.Builder
	content.WriteString("# AURA.md\n\n")
	content.WriteString("This file provides guidance for Aura when working in this workspace.\n\n")
	content.WriteString("**Note**: This is a basic template. For richer documentation adapted to your workspace type, use:\n")
	content.WriteString("- TUI: `/init` command\n")
	content.WriteString("- CLI: `aura init` command\n\n")
	content.WriteString("## Workspace Overview\n\n")
	content.WriteString("Describe the purpose and structure of this workspace.\n\n")
	content.WriteString("## Key Locations\n\n")
	content.WriteString("List important files, directories, or resources.\n\n")
	content.WriteString("## Working Conventions\n\n")
	content.WriteString("Document any conventions, patterns, or workflows used here.\n\n")
	content.WriteString("---\n\n")
	content.WriteString("*Generated by `aura init`*\n")
