module github.com/oneliang/aura

go 1.26.1

require github.com/oneliang/aura/cli v0.0.0
...
require (
	...
	github.com/oneliang/aura/api v0.0.0 // indirect
	github.com/oneliang/aura/core v0.0.0 // indirect
